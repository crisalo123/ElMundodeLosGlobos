...
export const Ballons = () => {
  ...
  return (
    <section className="py-8  text-center px-4 md:px-16 overflow-hidden relative">
      <h2 className="text-3xl font-bold text-purple-700 mb-5 font-['Cinzel'] tracking-wide">
