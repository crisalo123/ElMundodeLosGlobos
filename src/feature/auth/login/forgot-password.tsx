...
import backgroundLogin from '../assets/LogoPayBill.png' 
...
export const ForgotPassword = () => {
  ...
  return (
    ...
    <div className='bg-gradient-to-r from-success-200 to-success-800 w-full h-16 absolute top-0'>
     </div> 
     <Wrapper className='flex h-full  items-center justify-center  md:pl-0  '>
        <div className='grid grid-cols-2   w-full  '>
          ...
          <div id="Formulario" className=" col-span-1 w-[530px] mb-5  justify-center mx-auto border-[1px] rounded-md border-success-800 md:mt-10 2xl:mt-0">                      
